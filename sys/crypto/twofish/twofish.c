...
#ifndef extract_byte
#define extract_byte(x,n)   ((u_int8_t)((x) >> (8 * n)))
#endif
...
static const u_int8_t q_tab[2][256] = {
    {
...
static u_int32_t mds_rem(u_int32_t p0, u_int32_t p1)
{
    u_int32_t  i, t, u;
...
{
    u_int32_t  i, a, b, me_key[4], mo_key[4];
    u_int32_t *l_key, *s_key;
